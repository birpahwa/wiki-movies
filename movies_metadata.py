...
conn.commit()
data1=pd.read_csv('Data/movies_metadata.csv', dtype='unicode')
...
collect.to_csv('Data/meta_new.csv')
cur.execute("copy movies_metadata FROM 'Data/meta_new.csv' DELIMITER ',' CSV")
